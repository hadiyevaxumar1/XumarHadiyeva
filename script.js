...
function findProductByName(productName) {
    for (let shop of shopGoods) {
        for (let product of shop.products) {
            if (product.product_name === productName) {
                console.log("Məhsulun adı:", product.product_name);
                console.log("Təsviri:", product.product_description);
                console.log("Qiyməti:", product.product_price);
                console.log("Mağaza adı:", shop.store_name);
                return;
    ...
    console.log("Bu adlı məhsul yoxdur.");
}
...
function showCart() {
    ...
    console.log('aldiginiz mehsullarin umumi qiymeti: ' + finalPrice);
}
            ...
            case '1':
                ...
                switch (action) {
                    ...
                    case "2":
                        ...
                        break;
                    case "3":
                        let order = prompt("Qiyməti necə sıralamaq istəyirsiniz? (artan yoxsa azalan):");
                    ...
                    case "6":
                        ...
                        break;
                    default:
                        console.log("Düzgün əməliyyat seçilməyib,yenidən cəhd edin.");
                }
                break;
            case '2':
